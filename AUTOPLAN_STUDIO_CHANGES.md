...
> **Hinweis zum Stand.** Dieses Dokument beschreibt die parallel entstandene
> Studio-Überarbeitung. Ihre Inhalte sind in den Hauptstrang eingeflossen; wo
> beide Fassungen dieselbe Stelle betrafen, gilt die zusammengeführte Lösung:
> Die Canvas-Zone ist ein Grid mit drei Zeilen (Badge, Leinwand,
> Algorithmuszustand) statt eines Flex-Stapels, und ein Playwright-Test misst
> die Rechtecke in beiden Visualisierungen. Der fortlaufende Änderungsbericht
> steht in `docs/AUTO-PLAN-CHANGELOG.md`.
