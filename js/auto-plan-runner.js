...
import { buildAutoPlan } from './auto-planner.js?v=20260803.6';
import { planProfileIds } from './auto-planner-engine.js?v=20260803.6';

const WORKER_URL = '/js/auto-plan-worker.js?v=20260803.6';
