...
export function normalizeSettings(value, { strict = false } = {}) {
  ...
  return {
    ...
    appearance: {
      ...
      monthColors: normalizedEnum(appearance.monthColors, new Set(['spectrum', 'rainbow', 'pastel', 'deep', 'classic', 'neutral']), DEFAULT_SETTINGS.appearance.monthColors, 'settings.appearance.monthColors', strict),
