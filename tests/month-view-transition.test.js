...
test('month motion is initialized before the color and stability layers', () => {
  const motionImport = controls.indexOf("import './month-view-transition.js?v=20260803.2';");
  const directorImport = controls.indexOf("import './color-director.js?v=20260803.2';");
  const stabilityImport = controls.indexOf("import './month-transition-stability.js?v=20260803.2';");
...
test('transition stylesheet and syntax check are shipped', () => {
  assert.match(motion, /\/transitions\.css\?v=20260803\.2/);
